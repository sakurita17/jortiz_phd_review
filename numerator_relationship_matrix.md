...
T_{3,1} \= 0.5(T_{1,1} + T_{2,1})
         \= 0.5(1 + 0) 
         \= 0.5 \\ 

T_{3,2} &= 0.5(T_{1,2} + T_{2,2})
         = 0.5(0 + 1)
         = 0.5 \\
...
T_{5,1} &= 0.5(T_{4,1} + T_{3,1}) 
         = 0.5(0.5 + 0.5) 
         = 0.5 \\

T_{5,2} &= 0.5(T_{4,2} + T_{3,2})
         = 0.5(0 + 0.5) 
         = 0.25 \\

T_{5,3} &= 0.5(T_{4,3} + T_{3,3}) 
         = 0.5(0 + 1) 
         = 0.5 \\

T_{5,4} &= 0.5(T_{4,4} + T_{3,4}) 
         = 0.5(1 + 0) 
         = 0.5 \\

T_{6,1} &= 0.5(T_{5,1} + T_{2,1}) 
         = 0.5(0.5 + 0) 
         = 0.25 \\

T_{6,2} &= 0.5(T_{5,2} + T_{2,2}) 
         = 0.5(0.25 + 1) 
         = 0.625 \\

T_{6,3} &= 0.5(T_{5,3} + T_{2,3}) 
         = 0.5(0.5 + 0) 
         = 0.25 \\

T_{6,4} &= 0.5(T_{5,4} + T_{2,4}) 
         = 0.5(0.5 + 0) 
         = 0.25 \\

T_{6,5} &= 0.5(T_{5,5} + T_{2,5}) 
         = 0.5(1 + 0) 
         = 0.5 \\
\end{aligned}
$$
